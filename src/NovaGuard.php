...
use novaguard\parts\Command;
use novaguard\database\Database;
use Discord\Parts\Embed\Embed;
use Discord\WebSockets\Intents;
use Symfony\Component\OptionsResolver\OptionsResolver;

class NovaGuard extends Discord implements NovaGuardInterface
{
    /**
    ...
    public function __construct(array $options = [])
    {
        ...
        $this->on('ready', function () {
            ...
            foreach ($this->commandClientOptions['prefixes'] as $key => $prefix) {
                if ($this->contains($prefix, ['@mention'])) {
    ...
    protected function resolveCommandClientOptions(array $options): array
    {
        ...
        $resolver
            ...
            ->setDefaults([
                ...
                'logger' => new \Monolog\Logger('novaguard-log')
            ]);
     ...
     * @return bool
     */
    protected function contains(string $string, array $matches): bool
    {
