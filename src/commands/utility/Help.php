...
EOF
        ...
        $embed->setDescription(
            sprintf(
                ...
                $prefix,
                "[Github](https://github.com/novaguard-team/novaguard-bot)"
            )
        );
	$embed->setImage("https://raw.githubusercontent.com/novaguard-team/novaguard-bot/master/resources/zero-two-novaguard.gif");
